...
namespace Com.Alipay
{
    ...
    /// </summary>
    internal sealed class RSAFromPkcs8
    {
        /// <summary>
        /// 签名
        /// </summary>
        ...
        /// <returns></returns>
        internal static string sign(string content, string privateKey, string input_charset)
        {
        ...
        /// <param name="input_charset">编码格式</param>
        /// <returns></returns>
        internal static bool verify(string content, string signedString, string publicKey, string input_charset)
        {
            bool result = false;
        ...
        internal static string decryptData(string resData, string privateKey, string input_charset)
        {
