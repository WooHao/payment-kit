...
namespace Com.Alipay
{
    ...
    internal class Core
    {
        ...
        internal static string CreateLinkString(Dictionary<string, string> dicArray)
        {
            ...
            {
                //var ttValue = "\"" + temp.Value + "\"";
                prestr.Append(temp.Key + "=" + temp.Value + "&");
                //prestr.Append(temp.Key + "=" + ttValue + "&");
            }
        ...
        internal static string CreateLinkString(Dictionary<string, string> dicArray, bool me)
        {
            StringBuilder prestr = new StringBuilder();
            foreach (KeyValuePair<string, string> temp in dicArray)
            {
        ...
        internal static void LogResult(string sWord)
        {
